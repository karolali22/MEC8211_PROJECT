...
plt.scatter(x, y, marker='s', color='red', facecolor='none', s=20, label=r'$C_L$ - Numerical')

plt.scatter(x_values, y_values, marker='D', s=20, label=r'$C_L$ - Experimental', color='black', facecolor='none')
...
plt.savefig('../results/confidence_intervals_CL.png', dpi=600)
