...
% Assuming 'poro_eff', 'Re', and 'k_in_micron2' are already calculated

% Open or create a file in append mode
fileID = fopen('simulation_results.txt', 'a');
...
% Define the format for writing the data to the file
% Here, we're using '%.12f' for floating-point numbers with 12 decimal places,
% and '\t' for a tab space between the numbers. '\n' is used to move to the next line
dataFormat = '%.12f\t%.12f\t%.12f\n';

% Write the values of 'poro_eff', 'Re', and 'k_in_micron2' to the file
fprintf(fileID, dataFormat, poro_eff, Re, k_in_micron2);
